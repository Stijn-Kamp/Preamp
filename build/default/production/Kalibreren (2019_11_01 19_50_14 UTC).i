...
void Kalibreren(void)
{
    ...
    int i;
    int ADres;
    char Controlle = eeprom_read(5);
    if(Controlle == 0b101010)
    {
        MinSpanning = eeprom_read(2) & 0b11;
        MinSpanning <<= 8;
        MinSpanning += eeprom_read(3);
        MaxSpanning = eeprom_read(0) & 0b11;
        MaxSpanning <<= 8;
        MaxSpanning += eeprom_read(1);
    }
    else
    {
        PORTA = 0b1110;
        ...
        eeprom_write(3, MinSpanning);
        eeprom_write(2, (MinSpanning >> 8) + (0b101010 << 2));
        ...
        eeprom_write(1, MaxSpanning);
        eeprom_write(0, (MaxSpanning >> 8) + (0b101010 << 2));
    }
    eeprom_write(5, 0b101010);
}
