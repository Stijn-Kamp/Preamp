...
# 10 "UpdateAfstand.c" 2

# 1 "./Definess.h" 1
# 25 "./Definess.h"
const char KANALENSCHAAL = 5 * 4;
# 62 "./Definess.h"
...
volatile unsigned int MaxSpanning = 1023;
volatile unsigned int MinSpanning = 0;
...
void UpdateAfstand(void)
{
        ...
        _delay((unsigned long)((4.16)*(4000000/4000000.0)));
        ...
        if(PORTBbits.RB0 == 0)
        {
            ...
            _delay((unsigned long)(((3*4.16))*(4000000/4000000.0)));
            _delay((unsigned long)(((80*4.16))*(4000000/4000000.0)));
...

            {
                ...
                if (Opslag1 == 0b01111011 || Opslag2 == 0b01111011)
                {
                    PORTAbits.RA1 = 1;
                    GlobalInput = 1;
                    Opdracht = 0b01111011;
                }
                else if (Opslag1 == 0b01110111 || Opslag2 == 0b01110111)
                {
                ...
                else if (Opslag1 == 0b01101111 || Opslag2 == 0b01101111)
                {
                ...
                {
                    _delay((unsigned long)((208*4.16)*(4000000/4000000.0)));
                    _delay((unsigned long)((3*4.16)*(4000000/4000000.0)));
            ...
            {
                if(Opslag1 == 0b10110111 || Opslag2 == 0b10110111)
                {

                    GlobalInput = 0;
                }
                if(Opslag1 == 0b10101111 || Opslag2 == 0b10101111)
                {

                    GlobalInput = 2;
                }
                if(Opslag1 == 0b10111011 || Opslag2 == 0b10111011)
                {
